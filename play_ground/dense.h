...
class dense : layer<matrix_over_field<long double>, matrix_over_field<long double>, long double>
{
public:
    ...
    matrix_over_field<long double> backward(const matrix_over_field<long double> &x, long double &lr);
};
...
matrix_over_field<long double> dense::backward(const matrix_over_field<long double> &x, long double &lr)
{
    printf("dense backward (%llu %llu)\n", this, this->W);
    matrix_over_field<long double> Wg;
    matrix_over_field<long double> Ilr;
    Ilr = lr;
    Wg = x * this->input.T();
